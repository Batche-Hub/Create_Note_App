...
public class MyDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_NOTE_CATEGORIE = "Note_Categorie";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String script = "CREATE TABLE " + TABLE_NOTE + "("
                ...
                +  COLUMN_NOTE_CONTENT +" TEXT," + COLUMN_NOTE_CATEGORIE+ " TEXT" + ")";
        // Execute Script.
        db.execSQL(script);
    }
    ...
    public void createDefaultNotesIfNeed()  {
        ...
        if(count ==0 ) {
            Note note1 = new Note("Firstly see Android ListView",
                    "List item 1", Categorie.TRAVAIL.toString());
            Note note2 = new Note("Learning Android SQLite",
                    "List item 2", Categorie.PERSO.toString());
            this.addNote(note1);
            this.addNote(note2);
        }
    }
    ...
    public void addNote(Note note) {
        ...
        values.put(COLUMN_NOTE_CATEGORIE, note.getCategorie());
    ...
    public Note getNote(int id) {
        ...
        Cursor cursor = db.query(TABLE_NOTE, new String[] { COLUMN_NOTE_ID,
                        COLUMN_NOTE_TITLE, COLUMN_NOTE_CONTENT,COLUMN_NOTE_CATEGORIE }, COLUMN_NOTE_ID + "=?",
    ...
    public List<Note> getAllNotes() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                note.setCategorie(cursor.getString(3));
                // Adding note to list
                noteList.add(note);
