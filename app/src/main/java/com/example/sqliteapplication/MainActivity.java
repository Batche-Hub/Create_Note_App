...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.listView = (ListView) findViewById(R.id.listViewCat);
    ...
    public void onCreateContextMenu(ContextMenu menu, View view,
        ...
        menu.add(0, MENU_ITEM_VIEW , 0, "Voir la Note");
        menu.add(0, MENU_ITEM_CREATE , 1, "Créer une Note");
        menu.add(0, MENU_ITEM_EDIT , 2, "Editer une Note");
        menu.add(0, MENU_ITEM_DELETE, 4, "Supprimer une Note");
    }
